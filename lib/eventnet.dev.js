...
function installAttr(name, value) {
    ...
    if (typeof value === "string") {
        exports._attrsStore.typed[name] = value;
    }
    else {
        ...
        exports._attrsStore.normal[name] = value;
    }
}
exports.installAttr = installAttr;
exports.en.installAttr = installAttr;
exports.getAttrDefinition = (name) => exports._attrsStore.typed[name] ||
    (!exports._attrsStore.normal[name].before
        && !exports._attrsStore.normal[name].after
        && !exports._attrsStore.normal[name].finish) ?
    void 0 :
    [(exports._attrsStore.normal[name].before || void 0),
        (exports._attrsStore.normal[name].after || void 0),
        (exports._attrsStore.normal[name].finish || void 0)];
