...
export class NormalNode extends BasicNode {
    ...
    private async _codeAsync(data: any, caller?: ILineLike): Promise<any> {
        ...
        let result = await this.code(this.downstream.wrappedContent, { data, caller }, { origin: this });
    ...
    private _codeSync(data: any, caller?: ILineLike): any {
        ...
        let result = this.code(this.downstream.wrappedContent, { data, caller }, { origin: this });
